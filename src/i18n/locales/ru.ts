...
export const dict: Dict = {
  ...
  "toast.updateModeSwitched": "Переключено на {name}",
  "toast.updateModeOff": "Обновления отключены",
  ...
  "update.deferredReload": "Новая версия готова. Страница автоматически обновится после окончания воспроизведения.",
