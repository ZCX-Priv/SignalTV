...
export const dict = {
  ...
  "toast.updateModeSwitched": "已切换到{name}",
  "toast.updateModeOff": "已关闭更新",
  ...
  "history.manage": "管理",
  "history.exitManage": "完成",
  "history.selectAll": "全选",
  "history.selectNone": "全不选",
  "history.selectedCount": "已选 {count} 条",
  "history.deleteSelected": "删除所选",
  "history.deleteConfirmTitle": "删除播放记录",
  "history.deleteConfirmDesc": "将删除所选的 {count} 条播放记录，此操作不可撤销。",
