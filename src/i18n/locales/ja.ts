...
export const dict: Dict = {
  ...
  "searchHistory.deleteConfirmTitle": "検索履歴を削除",
  "searchHistory.deleteConfirmDesc": "選択した {count} 件の検索履歴を削除します。この操作は元に戻せません。",
  ...
  "toast.updateModeSwitched": "{name}に切り替えました",
  "toast.updateModeOff": "更新を無効にしました",
  ...
  "update.done": "更新が完了しました",
  "update.checkFailed": "更新の確認に失敗しました。ネットワークを確認して再試行してください。",
  "update.deferredReload": "新しいバージョンの準備ができました。再生終了後にページを自動更新します。",
